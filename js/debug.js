...
function dummyStreams(){
	...
	i=3;
		...
		collect[i]['name']="blipblipblip";
		collect[i]['game']="WHEE";
		collect[i]['status']="aalter so ein langer text ich habe kein plan ob der ueberhaupt auf die seite passt abe3r ka bla blubbbasdlfkjalskerjölwqekjerlökwejrwlekrjwelrfkjsadfölksajdflsadkjfsldkfjsadlfkjsdflksajdflksdjflsdkfjsdlfkjsadlfkjsadlfökjsdaslkdjfölaskdjfölsadkfjslödfkjsadlfjsadlöfksjdfölskdfjsadlöfkjsadflksadjflsaödkfjsdlkfjsdölfkdlöfksjdlöfkjsadlfkjsadlfkjsadlfökjsadfölksadjflsadökfjsalödkfjsadlöfkjsd";
		collect[i]['logo']="https://static-cdn.jtvnw.net/jtv_user_pictures/jakyomanor-profile_image-87cb240acd3b73b8-300x300.jpeg";
		collect[i]['url']="";
		collect[i]['provider']="twitch";
